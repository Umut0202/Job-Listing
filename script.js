...
function getJobListingHTML(jobData, filterTags = []) {
  ...
  const newTagHTML = jobData.new ? `<span class="tag new">NEW!</span>` : "";
  const featuredTagHTML = jobData.featured
    ? `<span class="tag featured">FEATURED</span>`
    : "";

  let jobListingHTML = `
          <div class="jobs__item ${
            jobData.featured ? "jobs__item--featured" : ""
          }">
    ...
    jobData.company
                  ...
                  <div class="jobs__info">
                    <div class="jobs__company-wrapper">
